(() => {
  ...
  document.addEventListener("click",e=>{
    ...
    const view=e.target.closest("[data-view]");if(view){S.view=view.dataset.view;S.category="filmes";S.sortBy=S.view==="wanted"?"priority":"title";U.render();return;}
  ...
  $("#search").addEventListener("input",U.movies);$("#sort").addEventListener("change",e=>{S.sortBy=e.currentTarget.value;U.movies();});
  ...
  S.sortBy=S.view==="wanted"?"priority":"title";U.render();if(S.settings.apiUrl)sync(false);
})();
